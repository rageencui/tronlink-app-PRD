...
| 元素 | 行为 |
|------|------|
| 「USDT 兑换 (PSM)」按钮 | 跳转 `https://app.usdd.io/tron/psm`（in-app WebView） |
| 「存 TRX 铸造」按钮 | 跳转 `https://app.usdd.io/tron`（in-app WebView） |
...
| 入口 | 目标 URL | 打开方式 |
|------|----------|---------|
| PSM 兑换 | `https://app.usdd.io/tron/psm` | in-app WebView |
| Vault 铸造 | `https://app.usdd.io/tron` | in-app WebView |
